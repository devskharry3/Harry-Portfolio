...
const Hero = () => {
  ...
  return (
    ...
    <div className='mt-8 lg:mt-20' >
        <h1 className='hero-title text-3xl text-center uppercase sm:text-4xl lg:text-7xl mt-9'>{PROFILE.name}</h1>
        <h2 className='hero-subheading bg-gradient-to-b from-pink-200 to-purple-300 
        bg-clip-text text-center text-xl sm:text-2xl tracking-tighter text-transparent'>{PROFILE.role}</h2>

    </div>

    <p className='hero-text max-w-2xl p-2 text-center text-lg sm:text-xl -tracking-tighter lg:text-2xl'>
