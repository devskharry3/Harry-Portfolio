...
return (
    <div>
        <nav className='fixed left-0 right-0 z-50 lg:top-4'>
            {/*Desktop Menu*/}
            <div className='mx-auto hidden max-w-xl items-center justify-center rounded-full border
             border-white/30 py-2 backdrop-blur-lg lg:flex' >
                <div className='flex items-center justify-between gap-6'>
                    <div>
                        <a href="/">
                        <span className='uppercase'>SkHarry</span>
                        </a>
                    </div>
                    <div>
                ...
                <div className='py-2 backdrop-blur-md lg:hidden'>
                    <div className='flex items-center justify-between'>
                        <div>
                            <a href="/">
                                <span className='pl-2 uppercase'>Sk Harry</span>
                            </a>
                        </div>
